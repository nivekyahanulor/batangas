                    ...
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          ...
                          <textarea class="form-control"name="about" rows="8"/><?php echo $val->about;?></textarea>
                        </div> 
						<div class="mb-3">
                          <label class="form-label" for="basic-default-company">Terms and Condition:</label>
                          <textarea class="form-control"name="terms" rows="11"/><?php echo $val->termscondition;?></textarea>
                        </div>
						<?php } ?>  
